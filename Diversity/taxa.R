...
setwd('C:/Users/jmnix/OneDrive/Documents/Purdue/2023/Courses/BIOL 582- Microbial Genomics and Analysis/Project/apis_caste_sequence_data/filter0')
list.files()
...
metadata$Caste.ord = factor(metadata$Caste, c("Forager", "Nurse", "Male", "Queen", "Queen7D"))
levels(metadata$Caste.ord)
...
taxonomy<-read_qza("apis0-taxonomy.qza")
head(taxonomy$data)
...
physeq <- qza_to_phyloseq(
  features="apis0-core-metrics-results/rarefied_table.qza",
  tree="apis0-rooted-tree.qza",
  taxonomy = "apis0-taxonomy.qza",
  metadata = "apis0-metadata.tsv"
)
...
my_column <- "Caste"  #this is the metadata column that we will use in the taxa barplot
...
for(ml in my_level){
  ...
  physeq_meta_filtered$Caste.ord = factor(physeq_meta_filtered$Caste, c("Forager", "Nurse", "Male", "Queen", "Queen7D"))
...
diagdds = phyloseq_to_deseq2(physeq_deseq, ~ Caste)
...
alpha = 0.05
my_contrast = c("Caste", "Forager", "Nurse") 
my_contrast = c("Caste", "Forager", "Male") 
my_contrast = c("Caste", "Forager", "Queen") 
my_contrast = c("Caste", "Forager", "Queen7D")  
my_contrast = c("Caste", "Nurse", "Male") 
my_contrast = c("Caste", "Nurse", "Queen") 
my_contrast = c("Caste", "Nurse", "Queen7D")
my_contrast = c("Caste", "Male", "Queen") 
my_contrast = c("Caste", "Male", "Queen7D")
my_contrast = c("Caste", "Queen", "Queen7D")
